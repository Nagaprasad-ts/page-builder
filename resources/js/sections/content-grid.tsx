...
export const schema: SectionSchema = {
    ...
    items: {
        ...
        default: [
            ...
            { icon: 'Mail', title: 'Email Newsletters', body: 'Engaging campaigns that build relationship and loyalty.' },
            { icon: 'BookOpen', title: 'Case Studies', body: 'Detailed success stories that showcase your expertise.' },
        ],
        itemSchema: {
...
export default function ContentGridSection({
    ...
    return (
        <section className="bg-gray-50 py-16">
            <div className="mx-auto flex max-w-7xl flex-col gap-12 px-6 lg:flex-row lg:items-start lg:gap-16">
