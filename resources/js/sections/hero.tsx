...
export const meta: SectionMeta = {
    ...
    category: 'Marketing',
    icon: 'Sparkles',
    description: 'Full-width hero banner with heading, subtext, and a call-to-action button.',
};

export const schema: SectionSchema = {
    heading: { type: 'text', label: 'Heading', default: 'Welcome to our site' },
    subtext: { type: 'textarea', label: 'Subtext', default: 'A short description of what you do.' },
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-3xl px-6 py-24 text-center">
                {heading && (
                    <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl">{heading}</h1>
                )}
                {subtext && (
